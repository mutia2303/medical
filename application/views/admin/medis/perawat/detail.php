        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            ...
            <div class="post">
              ...
              <?php foreach ($detail_perawat->result_array() as $detail ) { ?>
        ...
        <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="verifikasi-medis<?php echo $detail['id_medis'];?>" class="modal fade">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <form class="form-horizontal" action="<?php echo base_url('admin/Home/verifikasi_perawat')?>" method="post" enctype="multipart/form-data" role="form">
